...
[CalloutProperties("Hit and Run Bicycle (Fatal)", "GGGDunlix", "2.0.0")]
public class HitAndRunBikeFatal : FivePD.API.Callout
{
    private Ped biker, driver2;
    private Vehicle bike, car2;
    public HitAndRunBikeFatal()
    {
        ...
        CalloutDescription = "A Car has struck a bicycle and fleed. Respond in Code 3 High.";
        ResponseCode = 3;
        StartDistance = 150f;
    }
